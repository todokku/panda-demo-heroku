...
public class AppLaunch {
	...
	public static void main(String[] args) throws Exception {
		...
		if (snioConnector != null) {
			...
			tomcat.setConnector(snioConnector);
			tomcat.getService().addConnector(snioConnector);
			tomcat.setPort(commandLineParams.sslport);
		}
	...
	static void setConnectorProperties(Connector nioConnector, CommandLineParams commandLineParams) throws URISyntaxException {
